...
for (i in 1:46){
  ...
  results_wm$outcome<-"T2D"
  write.csv(results_wm,paste("/PATH_TO_MY_FOLDER/results/T2D/2+SNPs_WeightedMedian/",cd4_data_files_name[i],"_median.csv",sep=""),row.names=FALSE)
}
